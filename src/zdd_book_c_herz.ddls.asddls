...
@EndUserText.label: 'Booking Comsumption entity'
@Metadata.ignorePropagatedAnnotations: true

@Metadata.allowExtensions: true
@Search.searchable: true
@ObjectModel.semanticKey: [ 'BookingID' ]
define view entity zdd_book_C_HERZ 
as projection on zdd_book_R_HERZ
{
  key BookingUUID,
      ...
      /* Associations */
      _BookStatus,
      _BookSuppl : redirected to composition child zdd_bspl_C_HERZ,
      _Carrier,
      _Conn,
      _Customer,
      _Travel            : redirected to parent ZDD_TRAV_c_HERZ
}
